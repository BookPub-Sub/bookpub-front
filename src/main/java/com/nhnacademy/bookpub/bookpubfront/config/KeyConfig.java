...
import com.nhnacademy.bookpub.bookpubfront.dto.KeyResponseDto;
import com.nhnacademy.bookpub.bookpubfront.exception.KeyMangerException;
...
public class KeyConfig {
    ...
    public String keyStore(String keyId) {
        try {
            ...
            InputStream result = new ClassPathResource("BookPub_V2.p12").getInputStream();
